...
describe("Auth", () => {
    ...
    it("passes provided offer data to FormField component", () => {
        ...
        expect(formFieldComponent.at(0).props().config).toEqual({ placeholder: "Email", type: "email" });
        expect(formFieldComponent.at(0).props().value).toBe("");
        expect(formFieldComponent.at(0).props().invalid).toBe(true);
        expect(formFieldComponent.at(0).props().shouldValidate).toEqual({ isEmail: true,required: true })
